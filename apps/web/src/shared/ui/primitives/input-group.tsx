...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: This is a div that acts as a group container
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: This is a div that acts as an addon container
    // biome-ignore lint/a11y/useKeyWithClickEvents: The onClick is for focusing the input when clicking outside of buttons
    <div
      role="group"
